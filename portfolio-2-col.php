...
<!-- Mirrored from speed-up.borisolhor.com/portfolio-2-col.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Oct 2015 09:21:22 GMT -->
<head>
    ...
    <body>  
        ...
        <section class="default-margin">
            <!-- .portfolio-2-col start -->
            <div class="portfolio portfolio-2-col">
                <!-- .container start -->
                <div class="container">
                    <!-- .row start -->
                    <div class="row d-animate d-callback d-delay04" data-callback="show_portfolio">
                        <div class="col-md-12">
                            ...
                            <div class="portfolio-grid">
                                ...
                                <div class="portfolio-grid-item portfolio-grid-item--height2 creative">
