...
<!-- Mirrored from speed-up.borisolhor.com/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Oct 2015 09:22:22 GMT -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>PSO - Page Not Found</title>
...
<body>  
    ...
    <!-- #main-404 start -->
    <section id="main-404" class="default-margin">
        <!-- .container start -->
        <div class="container">
            <!-- .row start -->
    ...
    </section><!-- #main-404 end -->

    <!-- #page-404 start -->
    <section id="page-404" class="default-margin">
        <!-- .container start -->
        <div class="container">
            <!-- .row start -->
            <div class="row section-info">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="section-title normal-case"><i>We Are Sorry,<br> But The</i> <em>Page Is Not Found!</em></h2>
