...
<!-- Mirrored from speed-up.borisolhor.com/project-single-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Oct 2015 09:21:53 GMT -->
<head>
        ...
        <section id="page-title" data-type="background" data-speed="7">
            ...
            <div id="page-title-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <h2>Project Single Slider</h2>
                        </div>
                        <div class="col-xs-6">
                            <ul class="breadcrumb">
                                <li class="active"><a href="index-2.html">Home</a></li>
                                <li><a href="project-single-slider.html">Project Single Slider</a></li>
                            </ul>
                        </div>
                    </div><!-- .row end -->
                </div><!-- .container end -->
