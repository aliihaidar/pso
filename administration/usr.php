									...
									<div class="row mbm">
										<div class="col-md12">
											<div class="table-responsive">
												<form id="frmMain" name="frmMain" method="post" enctype="multipart/form-data" action="mr_slideshow.php">
													...
													<table id="table_id" class="table table-hover table-striped table-advanced">
														<thead>
															<tr>
																...
																<th><?php echo $arrLang[$_SESSION['lang']]['us_avatar']; ?></th>
																<th><?php echo $arrLang[$_SESSION['lang']]['us_lname']; ?></th>
																<th><?php echo $arrLang[$_SESSION['lang']]['us_fname']; ?></th>
																<th><?php echo $arrLang[$_SESSION['lang']]['us_email']; ?></th>
																<th><?php echo $arrLang[$_SESSION['lang']]['us_username']; ?></th>
																<th><?php echo $arrLang[$_SESSION['lang']]['us_isactive']; ?></th>
																<th><?php echo $arrLang[$_SESSION['lang']]['us_gr_id']; ?></th>
																
																<th width="15%">Actions</th>
															</tr>
														</thead>
														<tbody>
															<?php include('usr.remote.php');?>
														</tbody>
											...
											<hr/>
											<div class="caption">
												<a href="usr.form.php" class="btn btn-success btn-circle"><i class="fa fa-plus"></i>&nbsp;Add New</a>
												<a href="javascript:deleteRecords('us_id');" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i>&nbsp;Delete Selected</a>
											</div>
										</div>
									</div>
								</div>
