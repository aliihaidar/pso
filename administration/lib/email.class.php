...
@example
	...
	$m = new email; // create the mail instance
	$m->From( "leo@isp.com" );
	...
	// Plain Text  : Body( $body, $charset="iso-8859-1", $contentType = "text/plain")... 
	// HTML Message: Body( $body, $charset="iso-8859-1", $contentType = "text/html")... 
...
Modifications By Fadi Chamieh (Class / file name / contentType )
	2003-01-22 11:40
*/
...
function From( $from ) {
	...
	if( ! is_string($from) ) {
		echo "Class email: error, From is not a string";
		exit;
	}
...
/*		Body( text [, charset [, content-type] ] )
 *		set the body (message) of the mail
 *		define the charset if the message contains extended characters (accents)
 *		default to us-ascii
 *		$mail->Body( "m�l en fran�ais avec des accents", "iso-8859-1" );
 */
function Body( $body, $charset="iso-8859-1", $contentType = "text/plain" ) {
