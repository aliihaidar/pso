...
class MySQL
{
	...
	public function __construct($connect = true, $database = null, $server = null,
								$username = null, $password = null, $charset = null, $port = null) {
	...
	Public function cloneObject($obj){
		$obj->cloneObjectProperties($this->db_host, $this->db_user, $this->db_pass, $this->db_dbname, $this->db_charset, $this->db_pcon, $this->mysql_link, $this->db_port);
	}
	Public function cloneObjectProperties($db_host, $db_user, $db_pass, $db_dbname, $db_charset, $db_pcon, $mysql_link, $db_port){
	 ...
	 */
	static private function BuildSQLColumns($columns, $addQuotes = false, $showAlias = true) {
		if ($addQuotes) {
			$quote = "`";
		} else {
			$quote = "";
	...
	*/
	...
	public function Open($database = null, $server = null, $username = null,
						 $password = null, $charset = null, $pcon = false, $port = null) {
		$this->ResetError();
		...
		if ($pcon) {
			...
			$this->mysql_link = @mysqli_connect (
				$this->db_host, $this->db_user, $this->db_pass, $this->db_dbname, $this->db_port);
		}
