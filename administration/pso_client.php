...
if (!$_SESSION['REDO']) {
	if ($cl_id) {
	    $cl_ids   = split('__', $cl_id);
	    
	    foreach ($cl_ids as $cl_id) {
	        $_REQUEST['cl_id']    = $cl_id;
                                            ...
                                            <div class="col-md12">
                                            	<div class="table-responsive">
                                            		<form id="frmMain" name="frmMain" method="post" enctype="multipart/form-data" action="<?php echo $actScript ?>">
                                                        ...
                                                        <table id="table_id" class="table table-hover table-striped table-advanced">
                                                            <thead>
											                    <tr>
											                        ...
											                        <th><?php echo $arrLang[$_SESSION['lang']]['cl_img']; ?></th>
																	<th><?php echo $arrLang[$_SESSION['lang']]['cl_title']; ?></th>
																	<th><?php echo $arrLang[$_SESSION['lang']]['cl_published']; ?></th>

																	<th width="15%">Actions</th>
											                    </tr>
											                </thead>
											                <tbody>
											                    <?php include('pso_client.remote.php');?>
											                </tbody>
                                                     ...
                                                     <hr/>
                                                     <div class="caption">
										                <a href="pso_client.form.php" class="btn btn-success btn-circle"><i class="fa fa-plus"></i>&nbsp;Add New</a>
										                <a href="javascript:deleteRecords('cl_id');" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i>&nbsp;Delete Selected</a>
			                                        </div>
                                             </div>
                                          </div>
                                       </div>
