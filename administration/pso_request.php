                                            ...
                                            <div class="col-md12">
                                            	<div class="table-responsive">
                                            		<form id="frmMain" name="frmMain" method="post" enctype="multipart/form-data" action="<?php echo $actScript ?>">
                                                        ...
                                                        <table id="table_id" class="table table-hover table-striped table-advanced">
                                                            <thead>
											                    <tr>
																	...
																	<th><?php echo $arrLang[$_SESSION['lang']]['re_name']; ?></th>
                                                                    <th><?php echo $arrLang[$_SESSION['lang']]['re_company']; ?></th>
                                                                    <th><?php echo $arrLang[$_SESSION['lang']]['re_email']; ?></th>
                                                                    <th><?php echo $arrLang[$_SESSION['lang']]['re_phone']; ?></th>
																	<th><?php echo $arrLang[$_SESSION['lang']]['re_published']; ?></th>

																	<th width="15%">Actions</th>
											                    </tr>
											                </thead>
											                <tbody>
											                    <?php include('pso_request.remote.php');?>
											                </tbody>
                                                     ...
                                                     <hr/>
                                                     <div class="caption">
										                <a href="pso_request.form.php" class="btn btn-success btn-circle"><i class="fa fa-plus"></i>&nbsp;Add New</a>
										                <a href="javascript:deleteRecords('re_id');" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i>&nbsp;Delete Selected</a>
			                                        </div>
                                             </div>
                                          </div>
                                       </div>
