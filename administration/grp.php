...
<head><title>PSO | Dashboard</title>
	...
	<link type="text/css" rel="stylesheet" href="assets/vendors/DataTables/extensions/TableTools/css/dataTables.tableTools.min.css">
									...
									<div class="panel-body">
										<div class="row mbm">
											<div class="col-md12">
														...
														<table id="table_id" class="table table-hover table-striped table-advanced">
															<thead>
																<tr>
																	...
																	<th><?php echo $arrLang[$_SESSION['lang']]['gr_title']; ?></th>
																	<th><?php echo $arrLang[$_SESSION['lang']]['gr_brief']; ?></th>
																	<th width="15%">Actions</th>
																</tr>
															</thead>
															<tbody>
																<?php include('grp.remote.php');?>
															</tbody>
												...
												<hr/>
												<div class="caption">
													<a href="grp.form.php" class="btn btn-success btn-circle"><i class="fa fa-plus"></i>&nbsp;Add New</a>
													<a href="javascript:deleteRecords('gr_id');" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i>&nbsp;Delete Selected</a>
												</div>
											</div>
										</div>
									</div>
